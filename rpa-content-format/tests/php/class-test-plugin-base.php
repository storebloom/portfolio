...
class Test_Plugin_Base extends \WP_UnitTestCase {
	...
	public function test_locate_plugin() {
		...
		$this->assertEquals( 'rpa-content-format', $location['dir_basename'] );
		$this->assertContains( 'plugins/rpa-content-format', $location['dir_path'] );
		$this->assertContains( 'plugins/rpa-content-format', $location['dir_url'] );
	}
	...
	public function test_relative_path() {
		$this->assertEquals( 'plugins/rpa-content-format', $this->plugin->relative_path( '/srv/www/wordpress-develop/src/wp-content/plugins/rpa-content-format', 'wp-content', '/' ) );
		$this->assertEquals( 'themes/twentysixteen/plugins/rpa-content-format', $this->plugin->relative_path( '/srv/www/wordpress-develop/src/wp-content/themes/twentysixteen/plugins/rpa-content-format', 'wp-content', '/' ) );
	}
	...
	public function test_add_doc_hooks_error() {
		$mock = $this->getMockBuilder( 'RpaContentFormat\Plugin' )->getMock();
		$obj = $this;
