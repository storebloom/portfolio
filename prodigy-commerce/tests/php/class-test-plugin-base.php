...
class Test_Plugin_Base extends \WP_UnitTestCase {
	...
	public function test_locate_plugin() {
		...
		$this->assertEquals( 'prodigy-commerce', $location['dir_basename'] );
		$this->assertContains( 'plugins/prodigy-commerce', $location['dir_path'] );
		$this->assertContains( 'plugins/prodigy-commerce', $location['dir_url'] );
	}
	...
	public function test_relative_path() {
		$this->assertEquals( 'plugins/prodigy-commerce', $this->plugin->relative_path( '/srv/www/wordpress-develop/src/wp-content/plugins/prodigy-commerce', 'wp-content', '/' ) );
		$this->assertEquals( 'themes/twentysixteen/plugins/prodigy-commerce', $this->plugin->relative_path( '/srv/www/wordpress-develop/src/wp-content/themes/twentysixteen/plugins/prodigy-commerce', 'wp-content', '/' ) );
	}
	...
	public function test_add_doc_hooks_error() {
		$mock = $this->getMockBuilder( 'ProdigyCommerce\Plugin' )->getMock();
		$obj = $this;
