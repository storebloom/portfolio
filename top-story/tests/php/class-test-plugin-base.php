...
class Test_Plugin_Base extends \WP_UnitTestCase {
	...
	public function test_locate_plugin() {
		...
		$this->assertEquals( 'top-story', $location['dir_basename'] );
		$this->assertContains( 'plugins/top-story', $location['dir_path'] );
		$this->assertContains( 'plugins/top-story', $location['dir_url'] );
	}
	...
	public function test_relative_path() {
		$this->assertEquals( 'plugins/top-story', $this->plugin->relative_path( '/srv/www/wordpress-develop/src/wp-content/plugins/top-story', 'wp-content', '/' ) );
		$this->assertEquals( 'themes/twentysixteen/plugins/top-story', $this->plugin->relative_path( '/srv/www/wordpress-develop/src/wp-content/themes/twentysixteen/plugins/top-story', 'wp-content', '/' ) );
	}
	...
	public function test_add_doc_hooks_error() {
		$mock = $this->getMockBuilder( 'TopStory\Plugin' )->getMock();
		$obj = $this;
