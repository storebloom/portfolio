...
class Test_Plugin_Base extends \WP_UnitTestCase {
	...
	public function test_locate_plugin() {
		...
		$this->assertEquals( 'investors-insert-content', $location['dir_basename'] );
		$this->assertContains( 'plugins/investors-insert-content', $location['dir_path'] );
		$this->assertContains( 'plugins/investors-insert-content', $location['dir_url'] );
	}
	...
	public function test_relative_path() {
		$this->assertEquals( 'plugins/investors-insert-content', $this->plugin->relative_path( '/srv/www/wordpress-develop/src/wp-content/plugins/investors-insert-content', 'wp-content', '/' ) );
		$this->assertEquals( 'themes/twentysixteen/plugins/investors-insert-content', $this->plugin->relative_path( '/srv/www/wordpress-develop/src/wp-content/themes/twentysixteen/plugins/investors-insert-content', 'wp-content', '/' ) );
	}
	...
	public function test_add_doc_hooks_error() {
		$mock = $this->getMockBuilder( 'InvestorsInsertContent\Plugin' )->getMock();
		$obj = $this;
