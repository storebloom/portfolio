...
class Test_Plugin_Base extends \WP_UnitTestCase {
	...
	public function test_locate_plugin() {
		...
		$this->assertEquals( 'investors-personal-tags', $location['dir_basename'] );
		$this->assertContains( 'plugins/investors-personal-tags', $location['dir_path'] );
		$this->assertContains( 'plugins/investors-personal-tags', $location['dir_url'] );
	}
	...
	public function test_relative_path() {
		$this->assertEquals( 'plugins/investors-personal-tags', $this->plugin->relative_path( '/srv/www/wordpress-develop/src/wp-content/plugins/investors-personal-tags', 'wp-content', '/' ) );
		$this->assertEquals( 'themes/twentysixteen/plugins/investors-personal-tags', $this->plugin->relative_path( '/srv/www/wordpress-develop/src/wp-content/themes/twentysixteen/plugins/investors-personal-tags', 'wp-content', '/' ) );
	}
	...
	public function test_add_doc_hooks_error() {
		$mock = $this->getMockBuilder( 'InvestorsPersonalTags\Plugin' )->getMock();
		$obj = $this;
